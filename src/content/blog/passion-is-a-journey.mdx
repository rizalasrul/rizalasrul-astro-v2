...
description: "Passion isn't always a straight line. From astronaut dreams to game development to web development, my career has evolved, and that's okay. The key is to stay open and embrace the journey."
icon: '1'
pubDate: 'Jan 16 2022'
...
import passion1 from '/src/assets/passion-is-a-journey-1.jpg';
import passion2 from '/src/assets/passion-is-a-journey-2.jpg';
...
<img src={passion1.src} alt="My final project" />
<img src={passion2.src} alt="My final project" />
