...
description: 'Discover what it means to be a pragmatic programmer. From being a fast adopter of technology to maintaining a continuous improvement mindset, learn the essential traits and qualities that define a pragmatic developer.'
icon: '1'
pubDate: 'Feb 03 2020'
